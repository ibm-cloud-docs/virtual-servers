...
For more information about the {{site.data.keyword.cloud_notm}} email delivery service, see [About email delivery](/docs/infrastructure/email-delivery?topic=email-delivery-getting-started).
