...
1. Try to power on your server. For more information, see [Power On/Off](/docs/virtual-servers?topic=virtual-servers-managing-virtual-servers#power-on-off){: new_window}.
...
For additional help, see [Getting help and support](/docs/virtual-servers?topic=virtual-servers-gettinghelp).
