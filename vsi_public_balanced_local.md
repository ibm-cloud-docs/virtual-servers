...
The offering is available in various flavors and data centers, with the following local storage options:
...
<table>
<CAPTION>Table 1. Balanced local storage flavors using local HDD</CAPTION>
<THEAD>
<TR>
<th>Flavor</th>
<th>vCPU</th>
...
## Local SSD {: #SSD}
<table>
<CAPTION>Table 1. Balanced local storage flavors using local SSD</CAPTION>
<THEAD>
<TR>
<th>Flavor</th>
<th>vCPU</th>
