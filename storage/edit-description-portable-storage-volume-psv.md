...
1. Access **Portable Storage** in the  [{{site.data.keyword.slportal}} ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://control.softlayer.com/){: new_window}. For more information, see [Accessing portable storage](access-portable-storage-screen.html){:new_window}.
