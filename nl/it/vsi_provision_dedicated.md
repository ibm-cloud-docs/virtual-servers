...
#### Provisioning delle tue istanze host dedicate
...
5.	Immetti le seguenti informazioni:
    ...
    <td>Puoi eseguire il provisioning di un massimo di quattro dischi di avvio aggiuntivi-SAN o locale-per istanza host dedicata.</td>
    </tr>
