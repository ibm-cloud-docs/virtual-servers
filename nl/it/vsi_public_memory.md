...
# Memoria 
Le caratteristiche di memoria sono migliori per i carichi di lavoro con uso intensivo di memoria, come i grandi carichi di lavoro con memorizzazione in cache, le applicazioni database intensive o i carichi di lavoro di analisi nella memoria.

L'offerta è disponibile nelle seguenti caratteristiche:

<table>
<CAPTION>Tabella 1. Caratteristiche di memoria</CAPTION>
<THEAD>
<TR>
...
Le caratteristiche di memoria sono disponibili in tutti i data center.
