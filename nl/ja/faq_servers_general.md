...
KVM コンソールに接続できない場合、問題の解決に役立つ下記のトラブルシューティングのヒントを確認してください。さらに問題が発生した場合には、サポートにお問い合わせください。サポートへの問い合わせについて詳しくは、[ヘルプおよびサポートの利用](../vsi/vsi_ts_index.html)を参照してください。
   ...
   * 標準の Java を通じて VSI に接続しようとしていて、エラーが続く場合は、VNC の使用を試すこともできます。VNC の使用について詳しくは、[Connecting to your VSI using VNC![「外部リンク」アイコン](../icons/launch-glyph.svg "「外部リンク」アイコン")](https://knowledgelayer.softlayer.com/articles/connect-your-vsi-using-vnc){: new_window} を参照してください。
...
サーバーへの root または管理者のパスワードが突然機能しなくなった場合には、サポートに問い合わせる前にご自分でチェックできることがいくつかあります。
