...
É possível fazer downgrade provisório de velocidades da porta sem abrir um chamado. É possível acessar a opção **Controles de porta** clicando em **Ações** no canto superior direito da página **Detalhes do dispositivo**. Nessa tela, selecione a velocidade necessária ou desconecte-a.
{:shortdesc}
